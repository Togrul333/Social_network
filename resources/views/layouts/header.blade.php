        ...
        <nav class="navbar navbar-inverse" role="navigation">
            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav" style="display:flex; align-items: center">
                    ...
                    <li>
                        <form style="display: flex" method="get" action="{{route('search')}}">
                            <input name="query" class="form-control me-2 scroll-link" type="search" placeholder="Search"
                                   aria-label="Search">
                            <button class="btn btn-success" type="submit">Найти</button>
                        </form>
                    </li>
                    <li><a href="{{asset('front/')}}/#" class="scroll-top">Home</a></li>
                    <li><a href="{{asset('front/')}}/#" class="scroll-link" data-id="about">Suggestions</a></li>
                    <li><a href="{{asset('front/')}}/#" class="scroll-link" data-id="portfolio">{{\Illuminate\Support\Facades\Auth::user()->name }}</a></li>
                    <li><a href="{{route('statuses')}}">Стена</a></li>
                    <li><a href="{{route('logout')}}">Выйти</a></li>
                                        @else
                    <li><div class="pop-button">
...
<div class="parallax-content baner-content" id="home">
    <div class="container">
        <div class="text-content">
            ...
            <h2><em>TINKER</em> <span>Соцыальная </span> сеть</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet aut distinctio eaque eum ipsa iste labore, modi nemo nesciunt nihil nobis perferendis qui quod, repellendus saepe! Alias culpa in quisquam repellendus sunt. Soluta..</p>
            <div class="primary-white-button">
                <a href="#" class="scroll-link" data-id="about">SUGGESTIONS</a>
            </div>
        </div>
    </div>
</div>
